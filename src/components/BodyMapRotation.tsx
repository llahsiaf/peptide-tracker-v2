      ...
      <Svg width="100%" height={260} viewBox="0 0 320 320">
        <Defs>
          ...
          <RadialGradient id="targetGlow" cx="50%" cy="50%" r="50%">
            <Stop offset="0%" stopColor="#DF8A3A" stopOpacity="0.6" />
            <Stop offset="60%" stopColor="#DF8A3A" stopOpacity="0.25" />
            <Stop offset="100%" stopColor="#DF8A3A" stopOpacity="0" />
          </RadialGradient>
        </Defs>
        ...
        <Line x1="160" y1="50" x2="160" y2="275" stroke="#3d2b29" strokeWidth="1.5" strokeDasharray="3 3" />
        <Line x1="70" y1="160" x2="250" y2="160" stroke="#3d2b29" strokeWidth="1.5" strokeDasharray="3 3" />
        ...
        <Circle cx="160" cy="160" r="10" fill="#1a100f" stroke="#DF8A3A" strokeWidth="2" />
        <Circle cx="160" cy="160" r="4" fill="#DF8A3A" />
        <SvgText x="160" y="145" textAnchor="middle" fill="#9c8985" fontSize="8" fontWeight="800">
            ...
            <G key={site.id} onPress={() => onSelectSite(idx)}>
              {isCurrent && (
                <>
                  ...
                  <Circle cx={site.cx} cy={site.cy} r="28" stroke="#DF8A3A" strokeWidth="1.5" strokeDasharray="3 3" opacity="0.9" />
                </>
              )}
              ...
              <Circle
                ...
                cy={site.cy}
                r="22"
                fill={isCurrent ? '#352423' : '#231716'}
                stroke={isCurrent ? '#DF8A3A' : '#3d2b29'}
                strokeWidth={isCurrent ? '2.5' : '1.5'}
              />

              <Circle cx={site.cx} cy={site.cy} r="5" fill={isCurrent ? '#c2d3b6' : '#3d2b29'} />
